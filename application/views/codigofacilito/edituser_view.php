  ...
  <body>
     <div class="container">
        ...
        <div class="page-header">
              ...
              <br><br>
                     <br><a class="btn btn-default " href="<?php echo base_url();?>index.php/usuario_controller/" title="ir a usuarios"><?php echo img('img/manager.png');?></a>
          ...
          <h1>Usuarios <small>editar usuario</small></h1><br>
          ...
          <center>
              <?php echo form_open() ?>
                ...
                <?php echo form_submit('enviar', 'actualizar');?>
