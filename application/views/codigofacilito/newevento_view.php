  ...
  <body>
     <div class="container">
        ...
        <div class="page-header">
          <ol class="breadcrumb">
                  <li><a href="<?php echo base_url();?>index.php/teatro_controller">Administracion</a></li>
          ...
          <h1>Administracion <small>Nuevo evento</small></h1>
            <br>

            <?php echo $error;?>
            
         
            <?php echo form_open_multipart('evento_controller/do_upload/1');?>
                ...
                <div class="row">
                    <div class="col-md-3">
                       <?php echo form_label('Fecha','lbl_fecha') ?>
                            <input type="date" name="fecha" min="2015-01-01" max="2054-12-31" required>
