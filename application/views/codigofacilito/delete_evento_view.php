     ...
     <div class="container">
        ...
        <div class="page-header">
          <ol class="breadcrumb">
                  ...
                  <li class="active">Eliminar evento</li>
              </ol>
              <a  href="<?php echo base_url();?>index.php/welcome/outSession"><?php echo img('img/out.png');?></a>
          <br><br><a class="btn btn-default " href="<?php echo base_url();?>index.php/usuario_controller/" title="ir a Nuevo Usuario"><?php echo img('img/manager.png');?></a>
          ...
          <h1>Evento <small>eliminar evento</small></h1>
          Esta seguro que quiere eliminar el evento <b><?php echo $datos_evento[0]->nombre; ?>?</b><br>

            <?php 
                $input_id = array(
                                    'id' => $datos_evento[0]->id
                                 );
            ?>
